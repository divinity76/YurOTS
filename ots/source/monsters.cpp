        ...
        while(p)
        {
            ...
            else if (strcmp(str, "attacks") == 0)
            {
                ...
                while(tmp)
                {
                    ...
                    {
                        int32_t cycleTicks = -1;
                        int32_t probability = -1;
                        int32_t exhaustionTicks = -1;
            ...
            else if (strcmp(str, "voices") == 0)
            {
                ...
                while(tmp)
                {
                    ...
                    {
                        int32_t cycleTicks, probability, exhaustionTicks;

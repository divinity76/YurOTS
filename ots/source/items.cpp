...
int32_t Items::dwMajorVersion = 0;
int32_t Items::dwMinorVersion = 0;
int32_t Items::dwBuildNumber = 0;
...
const ItemType& Items::operator[](int32_t id)
{
    ItemMap::iterator it = items.find(id);
    if ((it != items.end()) && (it->second != NULL))
        return *it->second;

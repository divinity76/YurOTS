...
#define _WIN32_WINNT 0x0601 //0x0601 dla win 7 , 0x0600 dla server 2008, 0x0502 win xp z sp2 oraz win serv 2003 z sp1, 0x0501 win xp i serv 2003
#endif
#include <windows.h>
...
inline int32_t OTSYS_THREAD_LOCKEX(HANDLE a, int32_t b)
{
...
inline int32_t OTSYS_THREAD_WAITSIGNAL(OTSYS_THREAD_SIGNALVAR& signal, OTSYS_THREAD_LOCKVAR& lock)
{
...
inline int32_t OTSYS_THREAD_WAITSIGNAL_TIMED(OTSYS_THREAD_SIGNALVAR& signal, OTSYS_THREAD_LOCKVAR& lock, __int64 cycle)
{
    ...
    int32_t ret = WaitForSingleObject(signal, tout);
    //EnterCriticalSection(&lock);
